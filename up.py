...
jumpy_jump = pygame.image.load('assets/jimp3.png').convert_alpha()
...
while run:
	...
	if game_over == False:
		...
		if fade_counter < SCREEN_WIDTH:
			...
			draw_text('GAME OVER!', font_big, WHITE, 180, 300)
			draw_text('SCORE: ' + str(score), font_big, WHITE, 180, 350)
			draw_text('PRESS SPACE TO PLAY AGAIN', font_big, WHITE, 90,400)
